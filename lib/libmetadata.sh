...
load_metadata_config() {
    ...
    selection_timeout=$(config_get_value_ini "$MODULE_NAME_METADATA" "framework" "selection_timeout" "$(_metadata_get_defaults "METADATA_SELECTION_TIMEOUT")")
    cache_enabled=$(config_get_value_ini "$MODULE_NAME_METADATA" "framework" "cache_enabled" "$(_metadata_get_defaults "METADATA_CACHE_ENABLED")")
    check_interval=$(config_get_value_ini "$MODULE_NAME_METADATA" "framework" "check_interval" "$(_metadata_get_defaults "METADATA_CHECK_INTERVAL")")
    default_apply_func=$(config_get_value_ini "$MODULE_NAME_METADATA" "framework" "default_apply_func" "$(_metadata_get_defaults "METADATA_DEFAULT_APPLY_FUNC")")
